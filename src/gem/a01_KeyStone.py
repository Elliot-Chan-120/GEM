...
# Analysis Modules
from src.gem.a02_1_CompositeDNA_Toolkit import CompositeDNA
from src.gem.a02_2_CompositeProt_Toolkit import CompositeProt
from src.gem.a02_3_DNAMatrix_Toolkit import DNAMatrix
...
class KeyStone:
    ...
    def __init__(self, model_name):
        ...
        self.genome_gz = GRCH38_GZ
        self.genome_decomp = GRCH38_FNA

        self.naivefile_df_outpath = REF_ALT_DF
        self.context_df_outpath = CONTEXT_DF

        # dataframe saves
        self.composite_dataframe = COMPOSITE_DF
        self.dna_profile_df = DNA_PROFILE
        self.prot_profile_df = PROT_PROFILE

        self.dna_pwm_profile_df = DNA_PWM_PROFILE
        self.aa_pwm_profile_df = AA_PWM_PROFILE

        self.hmm_profile_df = HMM_PROFILE
        # final dataframe for model training
        self.final_df_path = FULL_VARIANT_DF


        # model storage
        self.model_name = model_name
        self.model_path = MODEL_FOLDER / f"{self.model_name}"
